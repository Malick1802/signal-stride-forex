...
import { Bell, Check, CheckCheck, X, AlertCircle, CheckCircle, AlertTriangle, Info } from 'lucide-react';
...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({ children }) => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent 
        side="bottom" 
        className="h-[80vh] bg-slate-900/95 backdrop-blur-sm border-emerald-500/20"
      >
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between">
                          ...
                          {!notification.read && (
                            <div className="w-2 h-2 bg-emerald-500 rounded-full flex-shrink-0 ml-2 mt-1"></div>
                          )}
                        </div>
