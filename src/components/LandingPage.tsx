...
const LandingPage = ({ onNavigate }: LandingPageProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      {/* Mobile-First Header */}
      <header className="mobile-header bg-black/20 backdrop-blur-lg border-b border-white/10 px-4 py-3">
      ...
      <section className="relative px-4 pt-24 pb-12 sm:pt-12 text-center overflow-hidden">
